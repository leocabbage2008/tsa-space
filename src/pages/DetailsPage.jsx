        ...
        <Layout height="8000px" contentHeight="0px">
            <div className="all">
                ...
                <div className="scroll" id="centerText">
                    <h1 className="title center fixed clickThrough">
                        Meet the Ride
                    </h1>
                ...
                <div className="scroll container background" id="section1">
                    <p>
                        The main body of the ship spans 78 feet long and 20 feet
                        wide, providing plenty of space to enjoy the experience.
                    </p>
                </div>
                <img
                    src={shipInner}
                ...
                <div className="scroll container" id="section2">
                    <p>
                        The inside of the ship is split into 6 rooms, each with
                        special features.
                    </p>
                </div>
                ...
                <div className="scroll container background">
                    <p>
                        The cockpit holds 3 of our highly trained and
                        experienced pilots, ensuring your safety and comfort.
                    </p>
                </div>
                ...
                <div className="scroll container background">
                    <p>
                        The computer station uses our patented screen embeded in
                        the windows. Our specialized complementary internet
                        access allows you to surf the web with the backdrop of
                        space.{" "}
                    </p>
                </div>
                ...
                <div className="scroll container background" id="section3">
                    <p>
                        The movie station allows you to watch any movie on our
                        custom wide screen, and will also be where dashboard
                        providing information during launch and return.{" "}
                    </p>
                </div>
                ...
                <div className="scroll container background">
                    <p>
                        The dining area provides a comfortable area to converse
                        and dine. Our chefs have traveled around the work and
                        found the best ingredients to create the best food for
                        your appetite.
                    </p>
                </div>
                ...
                <div id="observationImageContainer">
                    ...
                    <div className="scroll" id="observationText">
                        ...
                        <p className="label">
                            Titan, the largest moon of Saturn and the only moon
                            in our solar system known to have clouds and a dense
                            atmosphere. It is the only body... →{" "}
                        </p>
                        <p className="label">
                ...
                <div className="scroll container background">
                    <p>
                        Also in the dining area, two interactive observation
                        stations provide information about passing astrological
                        features.
                    </p>
                </div>
