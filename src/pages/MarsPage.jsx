        ...
        <Layout>
            <div className="content">
                ...
                <h2>
                    ...
                    go through some of Mars's 'Seas'.
                </h2>
                <h1>
                    --------------------------------------------------------------------------------------
                </h1>
                ...
                <h2>
                    With over 100 locations on Mars, we provide places safe from
                    Mar's dust storms for you to relax, sleep, and recover from
                    Mars's low gravity. Also, we provide seasonal events on Mars
                    as it's Seasons also have a cycle just like Earth.
                </h2>
                <h1>
                    --------------------------------------------------------------------------------------
                </h1>
